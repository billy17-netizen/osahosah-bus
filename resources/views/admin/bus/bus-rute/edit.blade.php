        ...
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Rute</h4>
                </div><!-- end card header -->

                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{route('admin.bus-rute.update',$busRoute->id)}}" method="post"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="origin" class="form-control"
                                               placeholder="Enter Origin" value="{{$busRoute->origin}}"
                                               required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="destination" class="form-control"
                                               placeholder="Enter Destination" value="{{$busRoute->destination}}"
                                               required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="distance" class="form-control"
                                               placeholder="Enter Distance" value="{{$busRoute->distance}}"
                                               required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="duration" class="form-control"
                                               placeholder="Enter Duration" value="{{$busRoute->duration}}"
                                               required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="pickup_service_id" id="pickup_service"
                                               ...
                                               value="{{$busRoute->pickupService->pickup_location.' - '.$busRoute->pickupService->dropping_point.' ('.'Rp '. number_format($busRoute->pickupService->pickup_fee, 0, ',', '.').')'}}"
                                               required readonly>
                                        <input type="hidden" name="pickup_service_id" id="pickup_service_id"
                                               value="{{$busRoute->pickup_service_id}}">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
